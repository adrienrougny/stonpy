...
class Ontologies(Enum):
    ...
    SUBUNIT = set(["UNIT_OF_INFORMATION", "UNSPECIFIED_ENTITY_SUBUNIT", "SIMPLE_CHEMICAL_SUBUNIT", "MACROMOLECULE_SUBUNIT", "NUCLEIC_ACID_FEATURE_SUBUNIT", "COMPLEX_SUBUNIT", "SIMPLE_CHEMICAL_MULTIMER_SUBUNIT", "MACROMOLECULE_MULTIMER_SUBUNIT", "NUCLEIC_ACID_FEATURE_MULTIMER_SUBUNIT", "COMPLEX_MULTIMER_SUBUNIT", "PHENOTYPE_SUBUNIT"])
    ...
    STIMULATION = set(["STIMULATION", "NECESSARY_STIMULATION", "ABSOLUTE_STIMULATION", "CATALYSIS"])
    INHIBITION = set(["INHIBITION", "ABOSLUTE_INHIBITION"])
    MODULATION = STIMULATION | INHIBITION | set(["MODULATION"])
    INFLUENCE = set(["POSITIVE_INFLUENCE", "NEGATIVE_INFLUENCE", "UNKNOWN_INFLUENCE"])
    FLUX_ARC = set(["CONSUMPTION", "PRODUCTION"])
    LOGICAL_OPERATOR = set(["AND", "OR", "NOT", "DELAY"])
    GLYPH = EPN | AUXILLIARY_UNIT | PROCESS | LOGICAL_OPERATOR | ACTIVITY | set(["COMPARTMENT", "OUTCOME", "ENTITY", "INTERACTION_NODE", "EQUIVALENCE", "VARIABLE_VALUE", "SUBMAP", "TAG"])
    ARC = MODULATION | INFLUENCE | FLUX_ARC | set(["ASSIGNMENT", "INTERACTION", "LOGIC_ARC", "EQUIVALENCE_ARC"])
    ARCGROUP = set(["INTERACTION_ARCGROUP"])
